...
<title>Create a Multiple-choice, Multiple Answer Type Ballot</title>
...
<body id="main_body" >
	...
	<div id="form_container_mc1">
		<h1><a>Create a Multiple-choice, Multiple Answer Type Ballot</a></h1>
		<form id="electionlist" class="appnitro"  method="post" action="create_ballot_mc2_save.php">
		<div class="form_description">
			<h2>Create a Multiple-choice, Multiple Answer Type Ballot</h2>
