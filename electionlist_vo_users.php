<?php
	...
	/*
	 * This needs to query ballots where allvoters = 1
	 */
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="electionlist" class="appnitro"  method="post" action="electionlist_choice.php">
			...
			<p>These are election ballots that were created by another VoteOften user.  Only registered VoteOften users can vote on these ballots.</p>
	</div>
      <?php
      	switch($crud)	{
      		case "read":
